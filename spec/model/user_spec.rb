...
RSpec.describe User, type: :model do
  describe 'validations' do
    ...
    let!(:user_email_repeat) do
      { first_name: 'Игорь', second_name: 'Якунин', password: '987', password_confirmation: '987', email: 'user@mail.ru',
        phone: '+78888888888' }
    end
    let!(:user_phone_repeat) do
      { first_name: 'Игорь', second_name: 'Якунин', password: '987', password_confirmation: '987', email: 'test@mail.ru',
        phone: '+79999999999' }
    end
